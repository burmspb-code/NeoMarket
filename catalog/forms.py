...
class ProductForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'category': forms.Select(attrs={'class': 'form-select'}), # Для ForeignKey используем выпадающий список Select
            'description': forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'Введите описание товара...'}),
